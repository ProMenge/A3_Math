...
const Footer = () => {
  return (
    <motion.footer
      id="footer"
      className="relative bg-gradient-to-b from-slate-50 to-slate-200 dark:from-slate-900 dark:to-slate-700"
    ...
    >
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        {/* Container que controla a ordem em telas pequenas */}
        <div className="flex flex-col gap-8 lg:grid lg:grid-cols-4 lg:gap-8">
          ...
          <div className="order-4 lg:order-1">
            <div>
              ...
              />
              <img
                src="./src/assets/OcularWhite.png"
                alt="logoOcularWhite"
            ...
            <p className="mt-4 max-w-xs text-justify text-slate-500 dark:text-slate-400">
              Ocular é um projeto feito por um grupo de estudantes da Universidade
              Anhembi Morumbi (SP) com o intuito de facilitar a utilização de
              matrizes na edição de imagens.
            </p>

            <ul className="my-8 flex gap-6">
              <li>
                <p className="text-slate-700 transition dark:text-slate-200">
              ...
              <li>
                <a
                  href="https://github.com/ProMenge/A3_Math"
                  rel="noreferrer"
                  target="_blank"
          ...
          <div className="order-1 lg:order-2">
            <div className="mb-6">
              ...
              <li>
                <a
                  href="https://www.linkedin.com/in/fredericomenge/"
              ...
              <li>
                <a href="https://github.com/ProMenge" className="inline-flex items-center gap-1 text-slate-700 transition hover:opacity-75 dark:text-slate-200">
          ...
          {/* Colunas 3 e 4: Os outros seus conteúdos */}
          <div className="order-2 lg:order-2">
            <div className="mb-6">
              ...
              <ul className="mt-6 space-y-4 text-sm">
                <li>
                  <a
                    href="https://www.linkedin.com/in/g2a-giovanni/"
                    className="inline-flex items-center gap-1 text-slate-700 transition hover:opacity-75 dark:text-slate-200"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="order-3 lg:order-3">
            <div className="mb-6">
              ...
              <ul className="mt-6 space-y-4 text-sm">
                <li>
                  <a
                    href="https://www.linkedin.com/in/matehws/"
                    className="inline-flex items-center gap-1 text-slate-700 transition hover:opacity-75 dark:text-slate-200"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                ...
                <li>
                  <a href="https://github.com/Matehws" className="inline-flex items-center gap-1 text-slate-700 transition hover:opacity-75 dark:text-slate-200">
                    <svg xmlns="http://www.w3.org/2000/svg"
                      width="20"
                      height="20"
                      viewBox="0 0 64 64"
